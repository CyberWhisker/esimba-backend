...
const {getData, storeData, updateData, deleteData, getAppointmentData, getCertificateData, getAppointmentByParishId, getCertificateByParishId} = require('../controllers/RequestController')
